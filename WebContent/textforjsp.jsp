...
<%int i =5;%>
<!-- 跟 page3 page4 maybeforward.jsp 一起測試forward-->
...
<head>
    ...
    <title>跟 page3 page4 maybeforward.jsp 一起測試forward</title>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade ${(i==6)?'in active':'tab111'}" id="tab1" role="tabpanel">
                        目前點擊#TAB2 Directive
<%@ include file="maybeforward.jsp" %>
 </div>
                    <div class="tab-pane fade ${(i==6)?'tab222':'in active'}" id="tab2" role="tabpanel">
                        目前點擊#tab2
                    </div>
