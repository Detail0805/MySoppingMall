...
public class ShopOrderDAO implements ShopOrderDAO_interface {
	...
	private static final String GET_ALL_BUY_PRICE_BY_ORDERNO = "SELECT OT.ORDERNO,OT.ITEMNO,ORDERCOUNT,MEM_NO,ORDER_DATE,CUSTOMER_ADDRESS,CUSTOMER_PHONE,CUSTOMER_NAME,SP.NAME,SP.PRICE FROM SHOPORDER S JOIN ORDERDETAIL OT  ON (OT.ORDERNO = S.ORDERNO) JOIN SHOPPINGMALL SP  ON SP.ITEMNO = OT.ITEMNO WHERE OT.ORDERNO=?";
