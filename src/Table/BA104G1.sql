...
VALUES ('HD0001','吃零食也可以顧健康！巧克力不僅能養顏美容，連老年失智都可以預防',
...
，抗氧化能力（ORAC）數值大於1萬，抗發炎和抗氧化的表現優異，因此運用於肌膚保養方面，可以減少慢性紫外線暴露，進而預防皮膚提早老化。','EMP0006'  
);

INSERT INTO HEALTHNEWSDETAIL(HEALTHNO, NEWSTITLE, NEWSINTRO, EMP_NO)
VALUES ('HD0002','居家照護好便利　到宅護理「足」感心',
'居家護理以人為本，管理更入心!
...
老繭皮、雞眼、趾甲疾病與變形等問題，都可透過居家足部照護而獲得改善。','EMP0011'  
);

INSERT INTO HEALTHNEWSDETAIL(HEALTHNO, NEWSTITLE, NEWSINTRO, EMP_NO)
VALUES ('HD0003','醬料重鹹吃多傷腎 這些疾病也跟著來',
...
VALUES ('ND0001','居家安寧照護菁英班】讓我們一起學習有尊嚴的照護，熱烈報名中',
'人生最後一哩路該怎麼走?!讓我們一起學習有尊嚴的照護，與長輩分享這份「愛的禮物」!由深耕社區安寧照護超過20年的專業團隊及醫學中心安寧療護領域之專業人員組成之講師陣容。
以末期病人的生理、心理及心靈需求為中心，認識臨床症狀及規劃居家照護重點，瞭解照顧者的心理支持需求及陪伴關懷技巧，更將倫理議題及遺囑與預立醫療自主計畫納入課程重點；每個單元都有實務操作，透過角色扮演，讓學習更有成效。','EMP0014'  
);

INSERT INTO NEWSDETAIL(NEWSNO, NEWSTITLE, NEWSINTRO, EMP_NO)
VALUES ('ND0002','精彩花絮暨活動分享-8/1《照護放輕鬆》系列-在宅照護放鬆有撇步講座',
'8月1日與日本大王合作舉辦的第三場《照護放輕鬆》講座，現場獲得許多貴賓朋友支持，包括台北市社會局局長、新北市衛生局局長、衛生福利部照護司研究員前來，還有許多關心在宅照護議題的醫師、學者好朋友們，講座人潮爆滿，謝謝沒位置坐的朋友包容。','EMP0014'  
);

INSERT INTO NEWSDETAIL(NEWSNO, NEWSTITLE, NEWSINTRO, EMP_NO)
VALUES ('ND0003','南部的鄉親久等了，有我罩你7月起開始在大高雄地區服務囉!',
'居家照顧已經邁入第12年，服務範圍橫跨雙北、桃園及大台中、累積了上萬人次的服務經驗，今年七月將跨越濁水溪，成立「南區照護管理中心」，將以最完整且全方位的銀髮居家照顧網絡，來服務大高雄區域!
有我罩你以長輩為中心的服務設計，希望陪伴長輩的每一個老化階段:除了基本的生活、營養備餐、身體照顧、輔具及相關銀髮產品諮詢之外，還有更多客製化的服務，幫助長輩自主生活得愈久愈好，滿足長輩在家享老的願望。為了提供更完整的服務，除了一直以來的優質居家照顧服務，更於2016年建構了一站式的整合平台，將優質的銀髮照護用品納入「有我罩你」網站，同時整合了以雙北為主的「北區照護管理中心」、涵蓋大台中區的「中區照護管理中心」，加上最新成立的「南區照護管理中心」，並以全台通用的「412-8178」服務諮詢專線，增加使用服務的便利性，提供更多長輩優質的照護服務。','EMP0007'  
);
commit;
...
INSERT INTO SHOPAPPEALSCOMPLAIN( COMPLAINNO,ORDERNO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS) VALUES (to_char('SP'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000002',6,'0'),'商品有瑕疵,我覺得不行,收到已破損','您好,已收到您的申訴,立馬幫你更換寄送新的。','處理中');


INSERT INTO SHOPAPPEALSCOMPLAIN(COMPLAINNO,ORDERNO,COMPLAINDETAIL,COMPLAINSTATUS) VALUES (to_char('SP'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000004',6,'0'),'覺得商品太不實用,可以退貨嗎?','未處理');


INSERT INTO SHOPAPPEALSCOMPLAIN(
COMPLAINNO,ORDERNO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS)
VALUES (to_char('SP'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000005',6,'0'),'有使用上的問題,不會用阿!','您好,我們會請客服人員與您聯繫','已完成');
...
VALUES (to_char('HC'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('500002',6,'0'),'突然臨時有事, 請問可更改日期嗎？','未處理');


INSERT INTO HCCOMPLAIN(
COMPLAINNO,ORDER_NO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS)
VALUES (to_char('HC'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('500003',6,'0'),'長照人員大遲到','您好,已收到您的申訴,轉交給長照部上層做處理,照成您的不便,不好意思。','處理中');


INSERT INTO HCCOMPLAIN(
COMPLAINNO,ORDER_NO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS)
VALUES (to_char('HC'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('500004',6,'0'),'請問可以看到訂購成功媒合長照人員是哪位嗎？','您好在會員資料的訂單上可以看到','已完成');
...
COMPLAINNO,ORDER_NO,COMPLAINDETAIL,COMPLAINSTATUS)
VALUES (to_char('CR'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000001',6,'0'),'車子太顛坡阿','未處理');


INSERT INTO CARCOMPLAIN(
COMPLAINNO,ORDER_NO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS)
VALUES (to_char('CR'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000002',6,'0'),'請問司機可以更改嗎','您好,已轉交客服,客服人員會再與您聯繫','處理中');

INSERT INTO CARCOMPLAIN(
COMPLAINNO,ORDER_NO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS)
VALUES (to_char('CR'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000003',6,'0'),'司機好帥,請問單身嗎？','您好,已轉交司機,請司機給你line會再與您聯繫','已完成');
...
VALUES (to_char('MO'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000001',6,'0'),'餐點太清淡,下一餐可以換別的餐點嗎?','未處理');

INSERT INTO MEALORDERCOMPLIN(
COMPLAINNO,MO_NO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS)
VALUES (to_char('MO'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000002',6,'0'),'請問可以再多追加餐點嗎?','您好,我們會請客服人員與您聯繫','處理中');

INSERT INTO MEALORDERCOMPLIN(
COMPLAINNO,MO_NO,COMPLAINDETAIL,COMPLAINREPLY,COMPLAINSTATUS)
VALUES (to_char('MO'||LPAD(to_char(SHOPCOM_NO_SEQ.NEXTVAL),6,'0')),to_char(sysdate,'yyyymmdd')||'-'||LPAD('000001',6,'0'),'今天午餐的小黃瓜有點爛爛的','您好,這是我們客製化的爛小黃瓜','已完成');
COMMIT;
